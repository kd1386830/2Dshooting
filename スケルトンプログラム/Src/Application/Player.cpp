...
void C_Player::Update()
{
	...
	m_ShotFlg = (GetAsyncKeyState(VK_LBUTTON) & 0x8000);
...
void C_Player::Draw()
{
	...
	SHADER.m_spriteShader.DrawTex(&m_PlayerTex, Math::Rectangle(16, 0, 16, 16), 1.0f);
}
...
void C_Player::PlayerRotate()
{
	float dx = MOUSE.GetMousePos().x - m_PlayerPos.x;
	float dy = MOUSE.GetMousePos().y - m_PlayerPos.y;
